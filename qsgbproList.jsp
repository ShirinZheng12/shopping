...
<!-----------------banner------------------------------->
<div class="banner"><a href="#"><img src="image/temp/banner2.jpg"/></a></div>
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="/MyShop/admin_tomain">首页</a><span>/</span><a href="#" class="on">墙式壁挂</a>
    </div>
</div><!-----------------paintCon------------------------------->
<div class="paintCon">
<%--    <section class="wrapper">--%>
        <h3 style="text-align: center"><img src="image/temp/tit01.jpg"></h3>
            <p style="text-align: center"><img src="image/temp/paint01.jpg"/></p>
                ...
                <div class="paintList">
                    <a href="javascript:pro('${u.getGoodsid()}','${u.getGoodsname()}','${u.getGoodsprice()}')">
                        <dl>
                            ...
                            <dd style="text-align: center">【墙壁装饰】${u.getGoodsname()}</dd>
