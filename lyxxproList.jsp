...
<div class="banner">
    <a href="#">
        <img src="image/temp/perfume_Banner.jpg"/>
    </a>
</div>
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="/MyShop/admin_tomain">首页</a><span>/</span><a href="#" class="on">蜡艺香薰</a>
    </div>
</div><!-----------------paintCon------------------------------->
<div class="paintCon">
    <section class="wrapper">
        <h3><img src="image/temp/perfumeTit01.jpg"></h3>
        <p style="text-align: center"><img src="image/temp/xxB01.jpg"/></p>
        <div class="paintList">
            <d:forEach var="u1" items="${list3}">
                <a href="javascript:pro('${u1.getGoodsid()}','${u1.getGoodsname()}','${u1.getGoodsprice()}')">
                    <dl>
                        <dt><img src="${u1.getGoodsphoto()}"></dt>
                        <dd style="text-align: center">【香薰】${u1.getGoodsname()}</dd>
                        <dd style="text-align: center">￥${u1.getGoodsprice()}</dd>
                    </dl>
                </a>
            </d:forEach>
        </div>
    ...
    <section class="wrapper">
        <h3><img src="image/temp/perfumeTit02.jpg"></h3>
        <p style="text-align: center"><img src="image/temp/xxB02.jpg"/></p>
        <div class="paintList">
            <d:forEach var="u" items="${list4}">
                <a href="javascript:pro('${u.getGoodsid()}','${u.getGoodsname()}','${u.getGoodsprice()}')">
                    <dl>
                        ...
                        <dd style="text-align: center">【香薰】${u.getGoodsname()}</dd>
                        <dd style="text-align: center">￥${u.getGoodsprice()}</dd>
                    </dl>
                </a>
            </d:forEach>
        </div>
